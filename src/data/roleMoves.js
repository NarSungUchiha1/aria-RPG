const Explorer = [
    { name: 'Void Sense',    type: 'buff',   effect: 'agility_up', value: 30, duration: 3, cooldown: 4, cost: 5,  desc: 'Sharpen your senses in the void.' },
    { name: 'Rift Step',     type: 'buff',   effect: 'agility_up', value: 50, duration: 2, cooldown: 6, cost: 8,  desc: 'Move faster through unstable space.' },
    { name: 'Void Reading',  type: 'buff',   effect: 'intelligence_up', value: 40, duration: 3, cooldown: 5, cost: 7, desc: 'Read the void patterns.' },
    { name: 'Soul Ward',     type: 'shield', value: 80, cooldown: 6, cost: 10, desc: 'A brief ward of void energy.' },
    { name: 'Rift Escape',   type: 'buff',   effect: 'agility_up', value: 80, duration: 2, cooldown: 10, cost: 12, desc: 'Desperate escape through a micro-rift.' }
];
