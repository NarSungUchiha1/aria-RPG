module.exports = {
    MALACHAR: {
        miniBosses: [
            { name: "Malachar's Shade",     hp: 8000,  atk: 180, def: 60,  evasion: 14, exp: 800,  gold: 600,  moves: [{ name: 'Void Pulse',       damage: 1.8 }] },
            { name: "Malachar's Warden",    hp: 10000, atk: 200, def: 80,  evasion: 12, exp: 1000, gold: 800,  moves: [{ name: 'Dark Binding',     damage: 2.0 }] },
            { name: "Fracture Knight",      hp: 9000,  atk: 190, def: 70,  evasion: 16, exp: 900,  gold: 700,  moves: [{ name: 'Rift Slash',       damage: 1.9 }] },
            { name: "The Herald",           hp: 15000, atk: 240, def: 100, evasion: 20, exp: 1500, gold: 1200, moves: [{ name: "Herald's Judgment",damage: 2.5 }] },
            { name: "Void Colossus",        hp: 20000, atk: 260, def: 120, evasion: 10, exp: 2000, gold: 1500, moves: [{ name: 'Colossus Smash',   damage: 2.8 }] }
        ],
        boss: {
            name: 'Malachar',
            hp: 1000000000,
