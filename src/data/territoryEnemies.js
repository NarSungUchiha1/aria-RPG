...
module.exports = {
    ...
    ASSEMBLY: {
        ...
        miniBosses: [
            { name: 'Fractured Enforcer',  hp: 95000,  atk: 1600, def: 900,  exp: 3200, gold: 1800, evasion: 5,  moves: [{ name: 'Iron Mandate', damage: 1.8 }, { name: 'Chain Bind', damage: 1.2 }] },
            { name: 'Void Tax Collector',  hp: 78000,  atk: 1500, def: 700,  exp: 2800, gold: 2200, evasion: 15, moves: [{ name: 'Drain Toll', damage: 1.1 }, { name: 'Void Levy', damage: 1.5 }] },
            { name: 'Corrupted Guildsman', hp: 112000, atk: 900, def: 1200, exp: 3600, gold: 1500, evasion: 0,  moves: [{ name: 'Guild Law', damage: 1.6 }, { name: 'Ancient Protocol', damage: 1.3 }] },
            { name: 'Assembly Wraith',     hp: 65000,  atk: 900,  def: 400,  exp: 2400, gold: 1200, evasion: 25, moves: [{ name: 'Ghost Sanction', damage: 1.6 }, { name: 'Null Edict', damage: 1.9 }] },
            { name: 'Sealed Inquisitor',   hp: 130000, atk: 1000, def: 1500, exp: 4200, gold: 2000, evasion: 5,  moves: [{ name: 'Verdict Strike', damage: 2.0 }, { name: 'Void Sentence', damage: 2.0 }] },
        ]
    },
    ...
    WRATHBORNE: {
        ...
        miniBosses: [
            { name: 'Void Berserker',       hp: 105000, atk: 1900, def: 500,  exp: 3500, gold: 1600, evasion: 10, moves: [{ name: 'Reckless Charge', damage: 1.8 }, { name: 'Blood Frenzy', damage: 2.0 }] },
            { name: 'Fracture Reaver',      hp: 880000,  atk: 2000, def: 300,  exp: 3000, gold: 1400, evasion: 20, moves: [{ name: 'Void Rend', damage: 1.5 }, { name: 'Tear Reality', damage: 2.2 }] },
            ...
            { name: 'Void Ravager',         hp: 720000,  atk: 1500, def: 200,  exp: 2600, gold: 1300, evasion: 30, moves: [{ name: 'Savage Tear', damage: 2.5 }, { name: 'Chaos Slash', damage: 2.6 }] },
    ...
    REMNANTS: {
        ...
        miniBosses: [
            ...
            { name: 'Void Remnant Shade',   hp: 60000,  atk: 2600, def: 600,  exp: 3400, gold: 1800, evasion: 25, moves: [{ name: 'Remnant Slash', damage: 2.4 }, { name: 'Hollow Cry', damage: 1.8 }] },
            ...
            { name: 'Fracture Phantom',     hp: 700000,  atk: 2150, def: 300,  exp: 2800, gold: 1400, evasion: 35, moves: [{ name: 'Phase Rend', damage: 3.0 }, { name: 'Void Phase', damage: 2.2 }] },
