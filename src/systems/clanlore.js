...
╔══════════════════════════════════════╗
┃                                      
┃   📜 ARIA SYSTEM — FIELD REPORT     
┃   *THE THREE WHO CROSSED OVER*      
┃                                      
╠══════════════════════════════════════╣
┃                                      
...
┃  And the world is running out of     
...
┃                                      
┃  Where Ashen walks, enemies          
┃  are already half broken.            
┃                                      
╠══════════════════════════════════════╣
┃                                      
┃   PHANTOM CREST 🌘🩸                   
...
┃  Only 3 clans exist.                 
┃  Choose before the war ends.         
┃                                      
╚══════════════════════════════════════╝`;

module.exports = { CLAN_LORE };