...
async function sendDungeonAnnouncement(client, rank, boss, maxStage) {
    ...
    const announceMsg =
        ...
        `┃◆   Max Stage: ${maxStage}\n` +
        `┃◆   Boss: ${boss}\n` +
        `┃◆   Max Raiders: ${{ F:3, E:3, D:4, C:4, B:5, A:5, S:5, PF:3, PE:3, PD:4, PC:4, PB:10, PA:10, PS:100 }[rank] || 3}\n` +
        `┃◆ \n` +
